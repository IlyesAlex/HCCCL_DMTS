...
trial{trial_duration = 3000; trial_type = fixed; stimulus_event{picture{text{caption = "Most egy visszajelzést láthatsz a válaszodról.";font_size = 30;}timesup2_text;x = 0; y = 0;}timesup2_picture;}timesup2_event;}timesup2_trial;